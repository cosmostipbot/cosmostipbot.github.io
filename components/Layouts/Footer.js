            ...
            <React.Fragment>
                <footer className="footer-top-area pt-100 pb-70">
                    ...
                    <div className="footer-shape">
                        <img src={require("../../images/shape/footer-shape-one.png")} alt="Image" />
                        <img src={require("../../images/shape/footer-shape-two.png")} alt="Image" />
                    </div>
                </footer>
                        ...
                        <div className="row align-items-center">
                            ...
                            <div className="col-lg-3">
                                <div className="designed">
                                    <p>
                                        Designed By <i className='bx bx-heart'></i> <Link href="https://envytheme.com/"><a target="_blank">EnvyTheme</a></Link>
                                    </p>
                                </div>
                            </div>
                        </div>
