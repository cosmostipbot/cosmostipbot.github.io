        ...
        return (
            <div className="newsletter-area ptb-100">
                    ...
                    <div className="row align-items-center">
                        ...
                        <div className="col-lg-2">
                            <div className="newsletter-img">
                                <img src={require("../../images/newsletter-img.png")} alt="Image" />
                            </div>
                        </div>
                ...
                <div className="newsletter-shape">
                    <img src={require("../../images/shape/newsletter-shape-one.png")} alt="Image" />
                    <img src={require("../../images/shape/newsletter-shape-one.png")} alt="Image" />
                    <img src={require("../../images/shape/newsletter-shape-two.png")} alt="Image" />
                </div>
            </div>
        );
    }
